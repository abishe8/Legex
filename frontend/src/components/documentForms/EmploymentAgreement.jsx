...
function EmploymentAgreement() {
   ...
   function validateEmploymentAgreementData(formData) {
      const labels = {
         ...
         "initial-work-period": "Initial Work Period",
         "job-responsibilities": "Job Responsibilities",
         "salary-amount": "Salary Amount",
         "causal-leave-days": "Casual Leave Days",
         "causal-leave-in-words": "Casual Leave (in words)",
         "sick-leave-days": "Sick Leave Days",
         "sick-leave-in-words": "Sick Leave (in words)",
         "public-holidays-allowed": "Public Holidays Allowed",
         "public-holidays-in-words": "Public Holidays (in words)",
         "notice-period-duration": "Notice Period Duration",
         "notice-period-in-words": "Notice Period (in words)",
         "employee-advance-payment": "Employee Advance Payment",
         "employee-advance-payment-words": "Employee Advance (in words)",
      ...
      Object.entries(formData).forEach(([key, raw]) => {
         ...
         switch (key) {
            // agreement-date is <input type="date"> → browser handles validity
            ...
            case "employee-age":
               if (!/^\d+$/.test(val) || +val <= 0) {
                  errors[key] = "Employee Age must be a positive number";
               }
               break;

            case "salary-amount":
            case "employee-advance-payment":
               if (!/\d/.test(val)) {
                  errors[key] = `${labels[key]} must include a number`;
               }
               break;

            case "causal-leave-days":
            case "sick-leave-days":
            case "public-holidays-allowed":
               if (!/^\d+/.test(val)) {
            ...
            case "notice-period-duration":
               if (!/^\d+/.test(val)) {
                  errors[key] =
                     "Notice Period Duration must start with a number";
               }
               break;

            default:
               // all other fields just required
               break;
         }
      });
   ...
   const handleSubmit = async (e) => {
      ...
      const { isValid, errors } = validateEmploymentAgreementData(formData);
            ...
            <div className="agreement-form-wrapper">
               ...
               <form className="agreement-form" onSubmit={handleSubmit}>
                  <div className="form-inputs">
                     ...
                     <div>
                        <label htmlFor="dependant-name">
                           Enter Dependant Name:
                        </label>
                        <input
                     ...
                     <div>
                        <label htmlFor="initial-work-period">
                           Enter Initial Work Period:
                        </label>
                        <input
                     ...
                     <div>
                        <label htmlFor="causal-leave-days">
                           Enter Causal Leave Days:
                        </label>
                        <input
                     ...
                     <div>
                        <label htmlFor="causal-leave-in-words">
                           Enter Causal Leave In Words:
                        </label>
                        <input
                     ...
                     <div>
                        <label htmlFor="sick-leave-days">
                           Enter Sick Leave Days:
                        </label>
                        <input
                     ...
                     <div>
                        <label htmlFor="sick-leave-in-words">
                           Enter Sick Leave In Words:
                        </label>
                        <input
                     ...
                     <div>
                        <label htmlFor="public-holidays-allowed">
                           Enter Public Holidays Allowed:
                        </label>
                        <input
                     ...
                     <div>
                        <label htmlFor="public-holidays-in-words">
                           Enter Public Holidays In Words:
                        </label>
                        <input
                     ...
                     <div>
                        <label htmlFor="notice-period-duration">
                     ...
                     <div>
                        <label htmlFor="notice-period-in-words">
                           Enter Notice Period In Words:
                        </label>
                        <input
                     ...
                     <div>
                        <label htmlFor="employee-advance-payment">
                           Enter Employee Advance Payment:
                        </label>
                        <input
                     ...
                     <div>
                        <label htmlFor="employee-advance-payment-words">
                           Enter Employee Advance Payment Words:
                        </label>
                        <input
