...
function SaleAgreement() {
   ...
   function validateSaleAgreementData(formData) {
      const labels = {
         ...
         "sellers-name": "Seller's Name",
         "sellers-fathers-name": "Seller's Father's Name",
         "sellers-address": "Seller's Address",
         "purchasers-name": "Purchaser's Name",
         "purchasers-fathers-name": "Purchaser's Father's Name",
         "purchasers-address": "Purchaser's Address",
         "total-sale-price": "Total Sale Price",
         "total-sale-price-in-words": "Total Sale Price (in words)",
         "property-area": "Property Area",
         "advance-payment-amount": "Advance Payment Amount",
         "advance-payment-amount-in-words": "Advance Payment Amount (in words)",
         "cheque-number": "Cheque Number",
         "cheque-issuance-date": "Cheque Issuance Date",
         "cheque-drawn-date": "Cheque Drawn Date",
         "remaining-balance-amount": "Remaining Balance Amount",
         "remaining-balance-amount-in-words":
            "Remaining Balance Amount (in words)",
         "compensation-amount-for-breach": "Compensation Amount for Breach",
         "day-of-agreement-execution": "Day of Agreement Execution",
         ...
         "shop-flat-plot-number": "Shop/Flat/Plot Number",
      ...
      Object.entries(formData).forEach(([key, raw]) => {
         ...
         switch (key) {
            ...
            case "cheque-number":
               if (!/^\d+$/.test(val)) {
                  errors[key] = "Cheque Number must be numeric";
               }
               break;

            // browser date inputs handle date format for:
            // "agreement-day", "agreement-month",
            // "cheque-issuance-date", "cheque-drawn-date"

            default:
               // complex fields (boundaries, in‑words, etc.) – no extra checks
               break;
         }
      });
   ...
   const handleSubmit = async (e) => {
      ...
      const { isValid, errors } = validateSaleAgreementData(formData);
            ...
            <div className="agreement-form-wrapper">
               ...
               <form className="agreement-form" onSubmit={handleSubmit}>
                  <div className="form-inputs">
                     ...
                     <div>
                        <label htmlFor="sellers-fathers-name">
                           Enter Seller's Fathers Name:
                        </label>
                        <input
                     ...
                     <div>
                        <label htmlFor="sellers-address">
                           Enter Seller's Address:
                        </label>
                        <input
                     ...
                     <div>
                        <label htmlFor="purchasers-fathers-name">
                           Enter purchaser's Fathers Name:
                        </label>
                        <input
                     ...
                     <div>
                        <label htmlFor="purchasers-address">
                     ...
                     <div>
                        <label htmlFor="total-sale-price">
                     ...
                     <div>
                        <label htmlFor="total-sale-price-in-words">
                           Enter Total Sale Price-in Words:
                        </label>
                        <input
                     ...
                     <div>
                        <label htmlFor="advance-payment-amount-in-words">
                           Enter Advance Payment Amount in Words:
                        </label>
                        <input
                           placeholder="eg. Ten Lakh Rupees Only"
                           type="text"
                     ...
                     <div>
                        <label htmlFor="cheque-issuance-date">
                           Enter Cheque Issuance Date:
                        </label>
                        <input
                     ...
                     <div>
                        <label htmlFor="cheque-drawn-date">
                           Enter Cheque Drawn Date:
                        </label>
                        <input
                           placeholder="eg. 05/02/2024"
                           type="date"
                     ...
                     <div>
                        <label htmlFor="compensation-amount-for-breach">
                           Enter Compensation Amount For Breach:
                        </label>
                        <input
                     ...
                     <div>
                        <label htmlFor="day-of-agreement-execution">
                           Enter Day of Agreement Execution:
                        </label>
                        <input
                     ...
                     <div>
                        <label htmlFor="shop-flat-plot-number">
                           Enter Shop/Flat/Plot Number:
                        </label>
                        <input
